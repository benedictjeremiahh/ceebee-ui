...
const SCHEMA = {
  ...
  '--cb-tone-brand-bg': { kind: 'color', field: 'toneBrandBg' },
  '--cb-tone-info-bg': { kind: 'color', field: 'toneInfoBg' },
  '--cb-tone-success-bg': { kind: 'color', field: 'toneSuccessBg' },
  '--cb-tone-warning-bg': { kind: 'color', field: 'toneWarningBg' },
  '--cb-tone-danger-bg': { kind: 'color', field: 'toneDangerBg' },
...
const ANT_COLOR_TOKENS = {
  ...
  colorWarningBg: '--cb-tone-warning-bg',
  colorErrorBg: '--cb-tone-danger-bg',
  colorText: '--cb-fg',
