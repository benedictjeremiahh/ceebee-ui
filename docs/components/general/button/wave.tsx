...
import { Button, ConfigProvider, Flex } from '@ceebee/ui/client';
import type { ConfigProviderProps, GetProp } from '@ceebee/ui/client';
...
const showShakeEffect: WaveConfig['showEffect'] = (node, { component }) => {
  ...
  const loop = () => {
    ...
    (node as any).effectTimeout = requestAnimationFrame(() => {
      ...
      if (current === undefined || current === null || next === undefined || next === null) {
