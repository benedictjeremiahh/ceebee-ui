...
import { Card, Divider, Flex, Masonry, Typography } from '@ceebee/ui/client';
import type { GetProp, MasonryProps } from '@ceebee/ui/client';
import { createStaticStyles } from 'antd-style';
type MasonryItemType<T> = NonNullable<MasonryProps<T>['items']>[number];
