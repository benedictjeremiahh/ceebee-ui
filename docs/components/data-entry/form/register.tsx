...
import type { AutoCompleteProps, CascaderProps, FormItemProps, FormProps } from '@ceebee/ui/client';
import {
  AutoComplete,
  Button,
  Cascader,
...
// DefaultOptionType is not re-exported from the main entry upstream. AutoComplete's own public
// options type describes the same shape.
type DefaultOptionType = NonNullable<AutoCompleteProps['options']>[number];
