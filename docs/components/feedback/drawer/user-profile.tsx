...
import { Avatar, Col, Divider, Drawer, List, Row } from '@ceebee/ui/client';
    ...
    <>
        ...
        renderItem={(item) => (
          ...
          >
            <List.Item.Meta
              ...
              title={<a href="https://ceebee.dev">{item.name}</a>}
      ...
      <Drawer size={640} placement="right" closable={false} onClose={onClose} open={open}>
        ...
        <Row>
          ...
          <Col span={12}>
            <DescriptionItem title="Account" content="hello@ceebee.dev" />
          </Col>
        </Row>
        <Row>
          <Col span={12}>
        ...
        <Row>
          <Col span={12}>
            <DescriptionItem title="Email" content="hello@ceebee.dev" />
          </Col>
          <Col span={12}>
