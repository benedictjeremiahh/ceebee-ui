...
import { Button, Drawer, Flex } from '@ceebee/ui/client';
import type { DrawerProps, GetProp } from '@ceebee/ui/client';
...
const sharedContent = (
  <>
    <div style={lineStyle}>
      Following the Ceebee UI specification, we developed a React component library that contains a
