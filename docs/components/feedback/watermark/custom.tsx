...
import { ColorPicker, Flex, Form, Input, InputNumber, Slider, Typography, Watermark } from '@ceebee/ui/client';
import type { ColorPickerProps, GetProp, WatermarkProps } from '@ceebee/ui/client';
