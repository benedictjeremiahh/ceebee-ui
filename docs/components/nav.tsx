...
const GROUPS: Array<{ title: string; entries: Entry[] }> = [
  ...
  },
  {
    ...
    entries: [
      ...
      { href: '/form/number-input', label: 'InputNumber', kind: 'Atom' },
      { href: '/form/combobox', label: 'AutoComplete', kind: 'Atom' },
      { href: '/form/date-input', label: 'DatePicker', kind: 'Composition' },
      { href: '/form/time-input', label: 'TimePicker', kind: 'Composition' },
      { href: '/form/file-drop', label: 'Upload', kind: 'Composition' },
    ],
  },
  {
    title: 'Feedback',
    entries: [
      ...
      { href: '/feedback/empty-state', label: 'Empty', kind: 'Composition' },
    ],
  },
  {
    title: 'Overlay',
    entries: [
      { href: '/overlay/dialog', label: 'Modal', kind: 'Composition' },
  ...
  },
  {
    ...
    entries: [
      ...
      { href: '/data/stat-card', label: 'Statistic', kind: 'Composition' },
  ...
  },
  {
    ...
    entries: [
      ...
      { href: '/nav/menu', label: 'Dropdown', kind: 'Composition' },
      { href: '/nav/breadcrumbs', label: 'Breadcrumb', kind: 'Atom' },
      { href: '/nav/stepper', label: 'Steps', kind: 'Composition' },
