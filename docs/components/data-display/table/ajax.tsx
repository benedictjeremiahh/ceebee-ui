...
import type { GetProp, TableProps } from '@ceebee/ui/client';
import { Table } from '@ceebee/ui/client';

// This type is not re-exported from the main entry upstream.
// Table's own onChange signature carries the sorter argument.
type SorterResult<T> = Exclude<Parameters<NonNullable<TableProps<T>['onChange']>>[2], unknown[]>;
...
const getRandomuserParams = (params: TableParams) => {
  ...
  // Anything else the table hands back
