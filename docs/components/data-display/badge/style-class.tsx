...
import { Avatar, Badge, Card, Flex, Space } from '@ceebee/ui/client';
import type { BadgeProps, GetProp } from '@ceebee/ui/client';
import { createStaticStyles } from 'antd-style';

// This type is not re-exported from the main entry upstream.
type RibbonProps = React.ComponentProps<typeof Badge.Ribbon>;
